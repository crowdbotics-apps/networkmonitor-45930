"""
Django settings for networkmonitor_45930 project.
...
ROOT_URLCONF = 'networkmonitor_45930.urls'
...
WSGI_APPLICATION = 'networkmonitor_45930.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "networkmonitor_45930 API",
    "DESCRIPTION": "API documentation for networkmonitor_45930 App",
    "VERSION": "v1",
}
